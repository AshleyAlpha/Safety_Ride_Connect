  ...
  return (
      ...
      <div className="mx-auto max-w-screen-xl bg-cyan-700 p-36">
        <div className="mx-auto max-w-md"> {/* Adjusted max-w-lg to max-w-md */}
          <form onSubmit={handleSubmit} className="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8 bg-cyan-300">
            <p className="text-center text-lg font-medium text-black">Update Password</p>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border-gray-200 p-4 text-sm shadow-sm text-black bg-cyan-200 ${errors.email ? 'border-red-500' : ''}`}
                placeholder="Email"
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border-gray-200 p-4 text-sm shadow-sm text-black bg-cyan-200 ${errors.password ? 'border-red-500' : ''}`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border-gray-200 p-4 text-sm shadow-sm text-black bg-cyan-200 ${errors.confirmPassword ? 'border-red-500' : ''}`}
